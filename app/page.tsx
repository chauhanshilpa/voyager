      ...
      <div className="bg-white">
        <div className="flex lg:flex-row md:flex-col sm:items-center xs:flex-col justify-between row-1 mx-20">
          <div className="flex flex-col xs:items-center lg:items-start">
            <h1 className=" text-7xl mt-30 md:w-[76.52%] sm:w-[100%] font-playfair-display" style={{ fontWeight: 500, fontStyle: "italic" }}>
        ...
        <div className="flex flex-col min-h-screen mt-10 mx-10">
          <div className=" mx-auto p-4">
            <h1 className="text-5xl mb-8 font-playfair-display" style={{ fontWeight: 500, fontStyle: "italic" }}>
              Innovative Social-Fi App for Travelers, Social <br /> Networking With Financial Technology
            </h1>
            <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden p-6 mt-20 gap-8">
              ...
              <div className="w-full md:w-1/2 p-6">
                <h2 className="text-4xl font-semibold mb-4 mt-10">Random Chat App</h2>
        ...
        <div className="flex flex-col min-h-screen mx-10">
          <div className=" mx-auto p-4">
            <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden p-6 mt-20 gap-8">
              ...
              <div className="w-full md:w-1/2 p-6">
                <h2 className="text-4xl font-semibold mb-4">Decentralized Onchain <br /> Identity</h2>
                <p className="text-gray-700 mb-4 text-2xl w-3/5 mt-12">
                  Allows users to establish a
                  pseudo-anonymous onchain
                  identity, ensuring privacy and
                  security while maintaining a
                  trustworthy profile for
        ...
        <div className="flex flex-col min-h-screen mx-10">
          <div className=" mx-auto p-4">
            <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden p-6 gap-8">
              ...
              <div className="w-full md:w-1/2 p-6">
                <h2 className="text-4xl font-semibold mb-4 mt-10">Cults (Communities)</h2>
                <p className="text-gray-700 mb-4 text-2xl w-1/2 mt-12">
                  offer a space for users to join
        ...
        <div className="flex flex-col min-h-screen mx-10">
          <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden p-6 gap-8">
            ...
            <div className="w-full md:w-1/2 p-6">
              ...
              <p className="text-gray-700 mb-4 text-2xl w-1/2 mt-12">
                adventurous activities organized
                by users, allowing for unique
                travel experiences.
              </p>
              <button className="px-16 py-2 bg-black text-white rounded-full hover:bg-gray-800 mt-12">
                Learn more
        ...
        <div className="flex h-screen bg-white">
          <div className="flex flex-col justify-center items-center w-1/3 p-8 bg-white">
            <h1 className="text-3xl font-semibold mb-6">Ready to Join the Adventure?</h1>
